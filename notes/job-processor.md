...
- [Task Scheduling](task-scheduling.md) — same bounded-parallelism idea, applied to time slots
- [Rate Limiter](rate-limiter.md) — both use bounded resources and queuing; rate limiter caps over time, this caps in parallel
