# Stream Processor (Buffer + Delimiter Scan)
...
- [Sliding Window (Variable Size)](variable-size-longest-substring-without-repeatin.md) — the "tail" we keep is conceptually a window of "data not yet processed"
