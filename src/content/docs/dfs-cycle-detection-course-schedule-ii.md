---
title: "DFS Cycle Detection - Course Schedule II"
topic: "dfs, graph"
difficulty: "Medium"
frequency: "High"
---
...
- [Kahn's Algorithm (BFS)](/dsa-patterns/topological-sort-kahn-algorithm-course-schedul/) — alternative using BFS + in-degree
